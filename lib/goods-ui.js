...
export const PRIZE_IMAGE_NOTICE = '<p class="image-availability-note">画像は識別用イラストです。実物の写真ではありません。景品名もあわせてご確認ください。</p>';
...
export function renderGoodsInput(nextCampaign) {
  ...
  $("#goods-input-cards").insertAdjacentHTML("beforeend", PRIZE_IMAGE_NOTICE);
  updateGoodsTotals();
}
